...
<a href="javascript:void(0)" onclick="w3_close()" class="w3-button w3-hide-large w3-display-topleft" style="width:100%;font-size:22px">Close Menu</a>
 ...
 <div class="w3-bar-block">
    ...
    <a href="LoginParaBiblioteca.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Carrinho</a> 
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div id="modal01" class="w3-modal w3-black" style="padding-top:0" onclick="this.style.display='none'">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Altere as Informações do jogo da biblioteca</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <p>preencha todos os espaço para adicionar<br></p>
    <form target="_blank" action="/priquisa/alteraJogos" method="post">
    <div class="w3-section">
        <label>Codigo</label>
        <input class="w3-input w3-border" type="text" name="cod" value="${param.cod}" required>
      </div>
      <div class="w3-section">
        <label>Nome</label>
        <input class="w3-input w3-border" type="text" name="No" value="${param.No}" required>
      </div>
      <div class="w3-section">
        <label>Descricao</label>
        <input class="w3-input w3-border" type="text" name="Em" value="${param.Em}" required>
      </div>
      <div class="w3-section">
        <label>Data De Lancamento</label>
        <input class="w3-input w3-border" type="date" name="Mes" value="${param.Mes}" required>
      </div>
      <div class="w3-section">
        <label>Classificacao de Idade</label>
        <input class="w3-input w3-border" type="text" name="ci" value="${param.ci}" required>
      </div>
       <div class="w3-section">
        <label>Preço</label>
        <input class="w3-input w3-border" type="text" name="pre" value="${param.pre}" required>
      </div>
      <div class="w3-section">
        <label>Imagem</label>
        <input class="w3-input w3-border" type="text" name="img" value="${param.img}" required>
      </div>
